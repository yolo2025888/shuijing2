var e = require("../../@babel/runtime/helpers/objectSpread2"),
  ...
  n = require("../../contracts/navigation/query-contract").appendQueryParams,
...
function z() {
  ...
  if (!e) return "";
  try {
    var t = String(e.getStorageSync("stonelab_client_view_id_v1") || "").trim();
    if (t) return t;
    var r = "pv_"
      .concat(Date.now(), "_")
...
function oe(e) {
  return {
    ...
    productPhotosStatus: (Array.isArray(e) ? e : []).length ? "ready" : "empty",
  };
}
function ue(e) {
  var t = e && "object" === a(e) ? e : {},
...
function pe(e) {
  ...
  var i = ce(t.bgIndex, void 0 !== t.bg_index ? t.bg_index : 0),
    ...
    d = {
      ...
      date:
        String(t.date || "").trim() || new Date().toISOString().slice(0, 10),
      previewUrl: s,
      snapshotUrl: s,
    };
  c &&
...
function he(e, t, r) {
  ...
  try {
    ...
    s(a), i.forEach(s), wx.setStorageSync("jieshanshi_schemes", o.slice(0, 80));
  } catch (e) {}
  return a.id;
}
function me(e) {
  ...
  if (e) {
    ...
    if (i && Number.isFinite(Number(r)) && !(Number(r) <= 0)) {
      var o = Math.max(0, Date.now() - Number(r)),
        u = Object.assign({ durationMs: o }, n && "object" === a(n) ? n : {});
...
function Pe(e, t) {
  var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 680;
...
function je(e) {
  e &&
    ...
    (e._applyLaunchLockTimer &&
      (clearTimeout(e._applyLaunchLockTimer), (e._applyLaunchLockTimer = null)),
    (e._applyLaunchToken = ""),
    e.data &&
  ...
  applyProductPayload: function (e, t) {
    var r = this,
      ...
      d = (function (e) {
        ...
        return !1 === t.usesDesignerIdentity || !1 === t.uses_designer_identity
          ? Object.assign({}, r, {
          ...
          function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  if (
                    (s = String((u.data && u.data.presetId) || "").trim()) &&
                ...
                case 6:
                  if (
                    ((c = t.sent),
                    i === u._productStructureHydrationToken &&
                      String((u.data && u.data.presetId) || "").trim() === s)
                  ) {
                    t.next = 9;
                    break;
                  }
                ...
                case 9:
                  ...
                  return (
                    ...
                    (p =
                      u.data && u.data.detail && "object" === a(u.data.detail)
                        ? u.data.detail
                        : null),
          ...
          for (;;)
            switch ((t.prev = t.next)) {
              ...
              case 21:
                return (
                  n.setData({
                    detail: Object.assign({}, p, { viewCount: Math.floor(d) }),
                  }),
                  t.abrupt("return", s)
                );
              case 23:
              ...
              switch ((t.prev = t.next)) {
                ...
                case 3:
                  return (
                    ...
                    (l =
                      o.data && o.data.detail && "object" === a(o.data.detail)
                        ? o.data.detail
                        : {}),
                    (t.prev = 8),
                    (t.next = 11),
              ...
              case 3:
                return (
                  ...
                  u(s, {
                    ...
                    recommendLimit: Number.isFinite(Number(c.recommendLimit))
              ...
              case 14:
                return (
                  ...
                  o.applyProductPayload(l, {
                    source: c.source || (c.forceRemote ? "remote" : "cache"),
                  }),
                  t.abrupt("return", l)
                );
              case 17:
                ...
                case 6:
                  if (
                    ...
                    (c = Number.isFinite(Number(i.bgIndex))
                      ...
                      : ""),
                    (d = ""
                      .concat("product-share-stonelab-diy-v2-bg-fbfaf8", ":")
                      .concat(s ? u.join(",") : o, ":")
                      .concat(c)),
              ...
              case 0:
                if (
                  ...
                  u &&
                    !X(u) &&
                    (_(u),
                    (a._visualLock = Object.assign({}, a._visualLock || {}, {
                      previewUrl: u,
                    })),
  ...
  handleHeroImageError: function (e) {
    ...
    if (r) {
      ...
      if (!n.length) {
        var i = Z(r);
        return !i || (t && i === t)
          ? void this.setData({ detail: Object.assign({}, r, { images: [] }) })
          : void this.setData({
  ...
  previewProductPhoto: function (e) {
    ...
    a.length &&
      ...
      wx.previewImage({
        urls: a,
        current:
          a[Math.max(0, Math.min(a.length - 1, Number.isFinite(r) ? r : 0))],
      });
  },
        ...
        return t().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              ...
              case 18:
                if (
                  ((c = F("inspiration" === e._entryFrom ? "inspiration" : "")),
                  (p =
                    "inspiration" === c
