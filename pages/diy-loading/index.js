...
var r = require("../../@babel/runtime/helpers/typeof"),
  a = require("../../contracts/navigation/query-contract").appendQueryParams,
  ...
  h = require("../../utils/diyTrayRenderImages").collectTrayRenderWarmupTargets,
...
function P(e, t) {
  ...
  if (o.startsWith("/pages/diy/index")) {
    ...
    var c = o.includes("?") ? "&" : "?",
      ...
      y =
        s && !u
          ? "".concat(m ? "&" : "", "returnTab=").concat(encodeURIComponent(s))
          : "",
      h = "".concat(m).concat(y);
...
function U(e) {
  ...
  if (a && Array.isArray(a.pattern) && a.pattern.length)
    return {
      ...
      materialMap:
        a.materialMap && "object" === r(a.materialMap) ? a.materialMap : null,
      materialSnapshot:
  ...
  var i = (function (e) {
    ...
    try {
      ...
      var o = Number(n && (void 0 !== n.bgIndex ? n.bgIndex : n.bg_index)),
        ...
        d = Number(n && (n.previewRenderVersion || n.preview_render_version));
      return {
        id: t,
        pattern: i,
...
function V(e, t) {
  ...
  return (
    Object.keys(n).forEach(function (e) {
      var t = n[e],
        r = String(
          e || (t && (t.id || t.materialId || t.material_id || t.code)) || ""
        ).trim();
      r && !a[r] && (a[r] = t);
    }),
    (e && Array.isArray(e.beadTypes) ? e.beadTypes : []).forEach(function (e) {
...
function H(e, t) {
  ...
  var i = t && "object" === r(t) ? t : {},
    ...
    s =
      a.subCategories && "object" === r(a.subCategories) ? a.subCategories : {},
            ...
            case 3:
              return (
                ...
                (y = d(
                  ...
                  .then(function (e) {
                    return Object.assign({ ready: !0, timedOut: !1 }, e || {});
                  })
                  .catch(function () {
                    return {
                      ready: !1,
...
Page({
  ...
  maybeRevealWithPartialP0: function (e) {
    if (this._criticalReady || this._redirected || this._unloaded) return !1;
            ...
            switch ((e.prev = e.next)) {
              case 0:
                return (
                  ...
                  (e.next = 5),
                  s({ forceRemote: !1, preferCache: !0, remoteTimeoutMs: 8e3 })
                );
              case 5:
                if (
                  ((i = e.sent),
              ...
              case 14:
                if (
                  ...
                  (a._entryP0Loaded = 0),
                  (a._entryP0ReadyRatio = A(a._entryP0Loaded, a._entryP0Total)),
                  l.length)
                ) {
                  e.next = 68;
                  break;
    ...
    if (!this._redirected) {
      ...
      var t = P(
        ...
        r = {
          ...
          renderDeviceTier:
            String(
              (this._diyRenderDeviceTier && this._diyRenderDeviceTier.tier) ||
                ""
            ).trim() || "normal",
